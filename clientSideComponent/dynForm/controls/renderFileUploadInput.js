// controls/renderFileUploadInput.js
import { createInputContainer } from './createInputContainer.js';

export function renderFileUploadInput(oneUIControl, baseEl, labelPositionAtContainerLevel) {
    ...
    const fileUpEl = $(`<label htmlFor="${oneUIControl.id}">${oneUIControl.label}:</label><input type="file" id="${oneUIControl.id}">`);
